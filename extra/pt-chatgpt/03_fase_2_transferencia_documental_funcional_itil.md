...
# 4. Alineamiento ITIL específico de la Fase 2

La Fase 2 se alinea principalmente con **Knowledge Management**, ya que su objetivo es transformar documentación dispersa, conocimiento tácito y experiencia funcional en una base de conocimiento útil, validada y accionable para la futura operación del servicio.

También se relaciona con otras prácticas ITIL porque el conocimiento funcional capturado será utilizado posteriormente para gestionar incidencias, problemas, cambios, niveles de servicio, riesgos, cumplimiento y mejora continua.

## 4.1 Prácticas ITIL relacionadas

| Práctica ITIL | Aplicación en esta fase |
|---|---|
| **Knowledge Management** | Capturar, estructurar, validar y mantener conocimiento funcional útil para soporte, mantenimiento y evolución. |
| **Business Analysis** | Entender procesos de negocio, reglas, usuarios, productos, excepciones y necesidades funcionales. |
| **Incident Management** | Identificar incidencias funcionales recurrentes, síntomas, diagnóstico, workaround y escalado. |
| **Problem Management** | Detectar problemas funcionales repetitivos, causas raíz conocidas o sospechadas y deuda operativa. |
| **Service Level Management** | Relacionar procesos funcionales con criticidad, impacto de negocio, SLAs y prioridades de atención. |
| **Information Security Management** | Identificar procesos con datos personales, datos sensibles, documentación contractual y obligaciones de trazabilidad. |
| **Change Enablement** | Identificar reglas, parametrizaciones y documentos cuyo cambio debe estar controlado. |
| **Service Configuration Management** | Relacionar procesos, aplicaciones, reglas, documentos y datos con los elementos de configuración inventariados en la Fase 1. |
| **Continual Improvement** | Registrar mejoras funcionales, documentales y operativas detectadas durante la transferencia. |

## 4.2 Objetivo ITIL de la fase

Desde la perspectiva ITIL, esta fase no debe limitarse a revisar documentos ni a celebrar sesiones funcionales. Su objetivo es generar **conocimiento operativo reutilizable**, de forma que el equipo entrante pueda:

- Entender los procesos funcionales críticos.
- Diagnosticar incidencias desde una perspectiva de negocio.
- Diferenciar errores técnicos de errores funcionales o de parametrización.
- Conocer reglas, excepciones, estados, documentos y comunicaciones.
- Identificar qué conocimiento está validado y cuál sigue pendiente.
- Saber qué información debe escalarse a negocio, legal, compliance, operaciones o equipos técnicos.
- Preparar la transferencia técnica profunda con preguntas funcionales concretas.

## 4.3 Evidencias ITIL esperadas

| Evidencia | Propósito |
|---|---|
| Base de conocimiento funcional | Convertir el conocimiento capturado en material útil para soporte y mantenimiento. |
| Matriz de documentación funcional | Saber qué documentación existe, qué cobertura tiene y cuál es su estado de validación. |
| Matriz de reglas de negocio | Identificar reglas críticas, fuente, implementación, responsable y criticidad. |
| Matriz de procesos funcionales | Relacionar procesos, aplicaciones, usuarios, productos y criticidad. |
| Catálogo documental | Controlar documentos contractuales, plantillas, generación, custodia y trazabilidad. |
| Catálogo de comunicaciones | Identificar comunicaciones obligatorias, destinatarios, plantillas y disparadores. |
| Matriz de parametrización funcional | Identificar parámetros críticos, responsables, controles y riesgos de cambio. |
| Matriz de incidencias funcionales recurrentes | Usar la experiencia real de soporte como fuente de conocimiento. |
| Registro de gaps funcionales | Controlar conocimiento pendiente, dudas, riesgos y acciones. |
| Actas de validación con negocio | Evidenciar que el conocimiento funcional ha sido contrastado. |

## 4.4 Principio de validación ITIL

Todo conocimiento funcional deberá clasificarse según su grado de fiabilidad. No debe tratarse igual una regla mencionada informalmente en una sesión que una regla validada por negocio, contrastada con tickets y localizada técnicamente.

Estados recomendados:

| Estado de conocimiento | Significado |
|---|---|
| Identificado | La información ha sido mencionada o localizada, pero aún no se ha revisado. |
| Documentado | La información está recogida en un documento, acta o matriz. |
| Contrastado | La información ha sido revisada con experto funcional, equipo saliente o negocio. |
| Validado | La información ha sido aceptada como correcta por el responsable correspondiente. |
| Probado | La información se ha comprobado con un caso real, ticket, prueba, operación o evidencia técnica. |
| Operativo | La información está lista para usarse en soporte, mantenimiento o formación del equipo. |
| Obsoleto | La información no refleja la realidad actual y no debe usarse sin revisión. |
| Pendiente | La información requiere aclaración, evidencia o validación adicional. |

## 4.5 Criterio ITIL de éxito de la Fase 2

La Fase 2 se considerará alineada con ITIL cuando el conocimiento funcional crítico haya pasado de estar disperso en documentos, personas y tickets a estar estructurado en una base de conocimiento revisable, con propietario, estado de validación, relación con procesos de negocio y utilidad directa para la operación del servicio.

---

# 5. Principios de trabajo de la Fase 2
...
# 7. Actividad 1. Preparar la transferencia funcional
...
# 8. Actividad 2. Revisar la documentación funcional existente
...
# 9. Actividad 3. Realizar sesiones funcionales por dominio
...
# 10. Actividad 4. Mapear procesos funcionales extremo a extremo
...
# 11. Actividad 5. Identificar reglas de negocio críticas
...
# 12. Actividad 6. Revisar parametrización funcional
...
# 13. Actividad 7. Revisar documentación contractual y comunicaciones
...
# 14. Actividad 8. Analizar tickets históricos desde perspectiva funcional
...
# 15. Actividad 9. Construir base de conocimiento funcional
...
## 15.5 Base de conocimiento funcional alineada con ITIL

Para que la base de conocimiento sea útil en operación, cada entrada debería contener información suficiente para ser utilizada por soporte, mantenimiento, análisis funcional y gestión de incidencias.

Campos recomendados:

| Campo | Descripción |
|---|---|
| ID de conocimiento | Identificador único de la entrada. |
| Proceso | Proceso funcional afectado. |
| Aplicación | Aplicación o conjunto de aplicaciones relacionadas. |
| Síntoma | Cómo se manifiesta la duda, incidencia o comportamiento. |
| Contexto funcional | Explicación de negocio necesaria para entender el caso. |
| Regla asociada | Regla de negocio, validación, cálculo, estado o excepción. |
| Diagnóstico funcional | Pasos para discriminar causa funcional, técnica o de datos. |
| Workaround | Solución temporal conocida, si existe. |
| Escalado | Responsable funcional, técnico, negocio, legal o compliance. |
| Evidencia | Ticket, acta, documento, prueba o caso real que lo respalda. |
| Estado de validación | Identificado, documentado, contrastado, validado, probado, operativo u obsoleto. |
| Propietario | Persona o rol responsable de mantener la entrada. |
| Fecha de revisión | Última fecha de contraste o actualización. |

## 15.6 Criterios de calidad de una entrada de conocimiento

Una entrada de conocimiento funcional podrá considerarse operativa cuando:

- Está redactada en lenguaje claro.
- Indica el proceso y aplicación afectados.
- Describe el síntoma o caso de uso.
- Incluye pasos de diagnóstico.
- Indica cuándo escalar y a quién.
- Está asociada a evidencias.
- Tiene propietario.
- Tiene estado de validación.
- No contradice documentación contractual, funcional o regulatoria.
- Ha sido revisada por el responsable funcional o por negocio cuando aplique.


# 16. Actividad 10. Identificar gaps funcionales
...
# 17. Actividad 11. Validar conocimiento funcional con negocio
...
# 18. Actividad 12. Preparar la transición hacia la Fase 3
...
# 19. Trazabilidad ITIL del conocimiento funcional

## 19.1 Objetivo

Asegurar que el conocimiento capturado en esta fase queda relacionado con procesos, aplicaciones, elementos de configuración, tickets, riesgos, SLAs, reglas de negocio y futuros procedimientos operativos.

Esta trazabilidad permite que la base de conocimiento no sea un repositorio aislado, sino una herramienta útil para la operación del servicio.

## 19.2 Matriz de trazabilidad funcional

| Proceso | Aplicación | Regla / documento / incidencia | CI relacionado | Evidencia | Riesgo asociado | Uso operativo |
|---|---|---|---|---|---|---|
| Emisión |  | Regla contractual / Documento / Ticket | APP / API / Batch / BD | Acta / Ticket / Documento |  | Soporte / Cambio / Diagnóstico |
| Recibos |  | Reproceso / Parametrización / Incidencia |  |  |  |  |
| Siniestros |  | Estado / Pago / Comunicación |  |  |  |  |

## 19.3 Relación con prácticas ITIL

| Elemento capturado | Práctica ITIL relacionada | Uso posterior |
|---|---|---|
| Procesos funcionales | Business Analysis / Service Level Management | Priorización, impacto y comunicación con negocio. |
| Reglas de negocio | Knowledge Management / Change Enablement | Control de cambios, pruebas y validación funcional. |
| Parametrizaciones | Change Enablement / Information Security Management | Control de modificaciones y trazabilidad. |
| Documentos contractuales | Knowledge Management / Information Security Management | Validación legal, auditoría y soporte. |
| Incidencias recurrentes | Incident Management / Problem Management | Diagnóstico, workaround y análisis de causa raíz. |
| Workarounds | Knowledge Management / Incident Management | Resolución rápida y reducción de dependencia personal. |
| Gaps funcionales | Risk Management / Continual Improvement | Plan de cierre, priorización y mejora. |
| Validaciones de negocio | Service Level Management / Relationship Management | Aceptación funcional y alineamiento con expectativas. |

## 19.4 Uso en fases posteriores

El conocimiento funcional validado en esta fase se utilizará para:

- Preparar la transferencia técnica profunda de la Fase 3.
- Priorizar el shadowing operativo de la Fase 4.
- Definir casos de reverse shadowing en la Fase 5.
- Establecer criterios de asunción progresiva en la Fase 6.
- Alimentar el backlog de mejora continua de la Fase 7.

---

# 20. Entregables de la Fase 2
...
## 20.2 Entregables ITIL específicos

| Entregable ITIL | Descripción | Responsable sugerido |
|---|---|---|
| Base de conocimiento funcional validada | Conocimiento funcional estructurado, accionable y con estado de validación. | Líder funcional + Service Manager |
| Registro de estados de conocimiento | Clasificación de conocimiento identificado, documentado, contrastado, validado, probado, operativo u obsoleto. | Transition Manager |
| Matriz de trazabilidad funcional ITIL | Relación entre procesos, aplicaciones, reglas, tickets, riesgos, CIs y uso operativo. | Líder funcional + Líder técnico |
| Catálogo de workarounds funcionales | Soluciones temporales conocidas, responsables, riesgos y condiciones de uso. | Service Manager |
| Registro de problemas funcionales recurrentes | Problemas repetitivos que deberán tratarse mediante Problem Management. | Service Manager + Líder funcional |
| Registro de mejoras funcionales | Mejoras documentales, operativas o de proceso candidatas a Continual Improvement. | Transition Manager |
| Evidencias de validación funcional | Actas, aprobaciones o revisiones de negocio sobre procesos, reglas y documentos críticos. | Negocio + Líder funcional |


# 21. Plantillas útiles de la Fase 2
...
## 21.6 Matriz de estado de conocimiento

| ID | Proceso | Aplicación | Tipo de conocimiento | Fuente | Estado | Evidencia | Propietario | Fecha revisión |
|---|---|---|---|---|---|---|---|---|
| KF-001 |  |  | Regla / Proceso / Documento / Workaround / Incidencia | Acta / Ticket / Documento / Experto | Identificado / Documentado / Contrastado / Validado / Probado / Operativo / Obsoleto |  |  |  |

## 21.7 Registro de problemas funcionales recurrentes

| ID | Proceso | Aplicación | Problema recurrente | Causa conocida | Workaround | Impacto | Acción recomendada |
|---|---|---|---|---|---|---|---|
| PF-001 |  |  |  | Conocida / Sospechada / Pendiente |  | Alto / Medio / Bajo | Abrir problema / Documentar KB / Revisar parametrización |

## 21.8 Registro de mejoras funcionales

| ID | Mejora | Origen | Beneficio esperado | Prioridad | Responsable | Estado |
|---|---|---|---|---|---|---|
| MF-001 |  | Sesión / Ticket / Gap / Validación negocio |  | Alta / Media / Baja |  | Propuesta / Aprobada / En curso / Implantada |


# 22. Checklist operativo de Fase 2
...
## 22.9 Checklist ITIL de conocimiento funcional

- [ ] Clasificar la documentación funcional según estado de validación.
- [ ] Identificar propietario de cada documento funcional crítico.
- [ ] Crear o actualizar la base de conocimiento funcional.
- [ ] Registrar entradas de conocimiento con evidencia asociada.
- [ ] Identificar reglas críticas con responsable y fuente.
- [ ] Relacionar reglas con aplicaciones y procesos.
- [ ] Identificar workarounds funcionales recurrentes.
- [ ] Relacionar incidencias funcionales con entradas de conocimiento.
- [ ] Identificar problemas funcionales recurrentes candidatos a Problem Management.
- [ ] Registrar gaps funcionales como riesgos, issues o acciones.
- [ ] Validar procesos críticos con negocio.
- [ ] Validar documentación contractual con negocio, legal o compliance cuando aplique.
- [ ] Identificar parametrizaciones sujetas a control de cambios.
- [ ] Relacionar procesos críticos con SLAs, impacto y prioridades de soporte.
- [ ] Preparar preguntas técnicas para localizar reglas, datos, documentos e integraciones en la Fase 3.


# 23. Riesgos específicos de la Fase 2
...
| No se clasifica el estado del conocimiento | Se usa información no validada como si fuera cierta | Aplicar estados ITIL: identificado, documentado, contrastado, validado, probado y operativo. |
| La base de conocimiento no es accionable | No ayuda al soporte real | Exigir síntoma, diagnóstico, workaround, escalado, evidencia y propietario. |
| Workarounds sin control | Se perpetúan soluciones manuales arriesgadas | Registrar workaround, riesgo, condiciones de uso y acción de mejora. |
| Reglas funcionales cambian sin control | Incidencias por cambios no gobernados | Relacionar reglas y parametrizaciones con Change Enablement. |
| Incidencias recurrentes no se convierten en problemas | Se repite el mismo fallo tras la transición | Crear registro de problemas funcionales recurrentes. |
| Conocimiento sin propietario | La documentación se degrada tras la transición | Asignar propietario y fecha de revisión a cada entrada crítica. |

---

# 24. Criterios de salida de la Fase 2
...
# 25. Recomendaciones prácticas para liderar la Fase 2
...
# 26. Resumen ejecutivo de la Fase 2
...
Desde el punto de vista ITIL, la fase debe dejar una base de conocimiento funcional suficientemente fiable para alimentar la futura operación del servicio. El conocimiento crítico debe tener propietario, estado de validación, relación con procesos y aplicaciones, y utilidad práctica para gestionar incidencias, problemas, cambios, escalados y mejoras.
