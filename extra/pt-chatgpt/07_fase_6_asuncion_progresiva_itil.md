...
# 4. Alineamiento ITIL específico de la Fase 6

La Fase 6 se alinea especialmente con ITIL porque representa el paso desde la ejecución supervisada hacia la **responsabilidad operativa principal** del servicio. En términos ITIL, esta fase debe demostrar que el equipo entrante no solo conoce el servicio, sino que puede gestionarlo dentro de un modelo de operación controlado, medible y alineado con los niveles de servicio acordados.

El objetivo ITIL de esta fase es asegurar que la asunción progresiva se realiza manteniendo la estabilidad del servicio, controlando los cambios, gestionando incidencias y problemas, reduciendo dependencias del equipo saliente y consolidando el modelo BAU.

## 4.1 Prácticas ITIL relacionadas

| Práctica ITIL | Aplicación en la Fase 6 |
|---|---|
| **Incident Management** | Gestión directa de incidencias por el equipo entrante, con escalado residual al equipo saliente cuando proceda. |
| **Problem Management** | Identificación de incidencias recurrentes, causas raíz pendientes y problemas que deben pasar al backlog BAU. |
| **Service Level Management** | Seguimiento reforzado de SLAs, SLOs, MTTR, MTTA, tickets reabiertos y degradación del servicio. |
| **Change Enablement** | Control de cambios durante la asunción, especialmente despliegues, cambios de configuración, hotfixes y reprocesos. |
| **Release Management** | Coordinación de releases y ventanas de despliegue mientras cambia la responsabilidad operativa. |
| **Deployment Management** | Ejecución progresiva de despliegues por el equipo entrante, con controles de rollback y evidencias. |
| **Monitoring and Event Management** | Seguimiento de alertas, eventos, dashboards y guardias durante el periodo de control reforzado. |
| **Service Configuration Management** | Actualización del registro de servicios, aplicaciones, componentes, responsables y estado de asunción. |
| **Knowledge Management** | Mantenimiento de runbooks, base de conocimiento, FAQs, procedimientos y lecciones aprendidas. |
| **Supplier Management** | Traspaso progresivo de relación operativa con proveedores externos y terceros críticos. |
| **Information Security Management** | Control de accesos, segregación de funciones, secretos, datos sensibles y evidencias de auditoría. |
| **Continual Improvement** | Conversión de gaps, riesgos, dependencias y deuda operativa en un registro de mejora continua. |

## 4.2 Objetivo ITIL de la fase

Desde el punto de vista ITIL, la Fase 6 debe demostrar que:

- El equipo entrante actúa como responsable principal del servicio.
- La operación se gestiona mediante los procesos ITSM definidos.
- Los niveles de servicio se mantienen bajo control.
- Los cambios se realizan siguiendo procedimientos aprobados.
- La monitorización y los eventos se atienden correctamente.
- Las incidencias recurrentes se transforman en problemas o mejoras.
- Las dependencias del equipo saliente se reducen y se registran.
- Los riesgos residuales se aceptan o mitigan formalmente.
- El modelo BAU queda activado de forma inicial.
- La operación puede pasar a estabilización con evidencias suficientes.

## 4.3 Evidencias ITIL esperadas

Durante esta fase deben generarse evidencias que permitan demostrar la asunción real del servicio:

| Evidencia | Finalidad |
|---|---|
| Plan de oleadas de asunción | Demostrar que la transferencia de responsabilidad se realiza de forma controlada. |
| Comunicaciones de cambio de responsabilidad | Alinear a cliente, negocio, mesa de servicio, operaciones y proveedores. |
| Panel de SLAs/SLOs | Medir que la calidad de servicio no se degrada. |
| Registro de incidencias gestionadas | Evidenciar operación real por el equipo entrante. |
| Registro de escalados al equipo saliente | Medir dependencia residual. |
| Registro de cambios y despliegues | Controlar Change Enablement y Deployment Management. |
| Registro de problemas recurrentes | Activar Problem Management. |
| Matriz de riesgos residuales | Controlar riesgos vivos durante la asunción. |
| Registro de soporte de proveedores | Evidenciar Supplier Management. |
| Actualización de runbooks y KB | Mantener Knowledge Management. |
| Registro de mejoras | Preparar Continual Improvement. |
| Decisión Go / No-Go a Fase 7 | Formalizar el paso a estabilización. |

## 4.4 Principio ITIL clave

La asunción progresiva no debe considerarse completa porque el equipo entrante haya empezado a operar, sino porque puede demostrar que opera el servicio **de forma estable, trazable, medible y controlada**, dentro de los procesos de gestión de servicio acordados.

La pregunta clave de esta fase es:

> ¿Puede el equipo entrante ser reconocido como responsable principal del servicio sin degradar SLAs, sin ocultar riesgos residuales y sin depender de forma crítica del equipo saliente?


# 5. Principios de trabajo de la Fase 6
...
# 7. Actividad 1. Definir el plan de asunción progresiva
...
# 8. Actividad 2. Definir el modelo de responsabilidad durante la asunción
...
# 9. Actividad 3. Activar la primera oleada
...
# 10. Actividad 4. Operar con control reforzado
...
# 11. Actividad 5. Gestionar incidencias durante la asunción
...
# 12. Actividad 6. Asumir despliegues y cambios de forma progresiva
...
# 13. Actividad 7. Asumir procesos batch y tareas sensibles
...
# 14. Actividad 8. Reducir gradualmente la dependencia del equipo saliente
...
# 15. Actividad 9. Estabilizar el modelo BAU inicial
...
# 16. Actividad 10. Gestionar comunicación durante la asunción
...
# 17. Actividad 11. Controlar SLAs, SLOs y calidad de servicio
...
# 18. Actividad 12. Gestionar riesgos residuales
...
# 19. Actividad 13. Evaluar preparación para cierre y estabilización
...
# 20. Actividad 14. Consolidar el control ITIL de la asunción

## 20.1 Objetivo

Asegurar que la asunción progresiva queda integrada en el modelo de gestión del servicio y no se limita a un cambio informal de responsables.

Esta actividad convierte la evidencia operativa de la Fase 6 en control ITIL: gestión de incidencias, problemas, cambios, niveles de servicio, configuración, proveedores, conocimiento y mejora continua.

## 20.2 Elementos a consolidar

| Elemento ITIL | Qué debe quedar consolidado |
|---|---|
| Incident Management | El equipo entrante gestiona incidencias como responsable principal y documenta resolución, impacto, escalado y cierre. |
| Problem Management | Las incidencias repetidas se agrupan como problemas, con causa raíz, workaround y acción preventiva. |
| Change Enablement | Los cambios realizados durante la asunción tienen aprobación, evidencia, validación y trazabilidad. |
| Release / Deployment Management | Las releases y despliegues se ejecutan con runbook, rollback y validación postdespliegue. |
| Service Level Management | Los SLAs y SLOs se revisan con métricas y tendencia, no solo con percepción. |
| Supplier Management | Los proveedores externos tienen contactos, SLAs, escalados y tickets de soporte conocidos por el equipo entrante. |
| Service Configuration Management | La mini-CMDB o registro de configuración refleja el nuevo responsable y estado de asunción. |
| Knowledge Management | Runbooks, FAQs, KB y procedimientos quedan bajo propiedad del equipo entrante. |
| Continual Improvement | Los gaps, dependencias y deuda operativa se trasladan a un registro de mejora continua. |

## 20.3 Matriz de control ITIL de asunción

| Servicio / aplicación | Incidencias | Problemas | Cambios | SLAs | Proveedores | Configuración | Conocimiento | Mejora continua |
|---|---|---|---|---|---|---|---|---|
|  | OK / Riesgo | OK / Riesgo | OK / Riesgo | OK / Riesgo | OK / Riesgo | OK / Riesgo | OK / Riesgo | OK / Riesgo |

## 20.4 Registro de problemas durante la asunción

| ID problema | Aplicación | Incidencias relacionadas | Causa probable | Workaround | Acción definitiva | Responsable | Estado |
|---|---|---|---|---|---|---|---|
| PRB-001 |  |  |  |  |  |  | Abierto / En análisis / Cerrado |

## 20.5 Registro de cambios durante la asunción

| ID cambio | Aplicación | Tipo | Riesgo | Aprobación | Ejecutado por | Resultado | Evidencia |
|---|---|---|---|---|---|---|---|
| CHG-001 |  | Release / Hotfix / Configuración / Batch | Alto / Medio / Bajo |  |  | Correcto / Fallido / Rollback |  |

## 20.6 Registro de proveedores asumidos

| Proveedor | Servicio | Aplicaciones afectadas | Canal de soporte | SLA tercero | Contacto operativo | Estado de traspaso |
|---|---|---|---|---|---|---|
|  |  |  | Portal / Email / Teléfono / ITSM |  |  | Pendiente / En curso / Asumido |

## 20.7 Registro de mejora continua derivado de la asunción

| ID | Mejora | Origen | Beneficio esperado | Prioridad | Responsable | Estado |
|---|---|---|---|---|---|---|
| MC-001 |  | Incidencia / Gap / Riesgo / Escalado / SLA |  | Alta / Media / Baja |  | Propuesta / Aprobada / En curso |

## 20.8 Resultado esperado

- Gestión ITIL consolidada en la operación asumida.
- Incidencias, problemas, cambios y SLAs bajo control del equipo entrante.
- Proveedores externos transferidos operativamente.
- Registro de configuración actualizado.
- Base de conocimiento bajo propiedad del equipo entrante.
- Mejoras post-transición preparadas para Fase 7.


# 21. Entregables de la Fase 6
...
| Registro de incidencias gestionadas durante la asunción | Evidencia de Incident Management por el equipo entrante. | Service Manager |
| Registro de problemas recurrentes | Problemas detectados durante la asunción para tratamiento BAU. | Service Manager |
| Registro de cambios y despliegues durante la asunción | Evidencia de Change Enablement, Release y Deployment Management. | Change Manager / líder técnico |
| Registro de proveedores asumidos | Evidencia de Supplier Management y traspaso operativo de terceros. | Service Manager |
| Registro de configuración actualizado | Actualización de responsables, estado de asunción y relaciones de servicio. | Líder técnico / Service Manager |
| Registro de mejora continua | Gaps, deuda operativa, automatizaciones y mejoras post-transición. | Transition Manager / Service Manager |

---

# 22. Plantillas útiles de la Fase 6
...
## 22.6 Matriz ITIL de responsabilidad asumida

| Servicio / aplicación | Responsable principal | Grupo ITSM | SLA aplicable | Soporte saliente | Proveedor externo | Estado |
|---|---|---|---|---|---|---|
|  |  |  |  | Ninguno / Bajo demanda / Condicionado |  | Asumido / Condicionado / Pendiente |

## 22.7 Registro de incidencias gestionadas por el equipo entrante

| Ticket | Aplicación | Severidad | SLA | Resuelto por entrante | Escalado | Causa | Acción de mejora |
|---|---|---|---|---|---|---|---|
|  |  | P1 / P2 / P3 | Cumplido / Riesgo / Incumplido | Sí / No | Saliente / Proveedor / Cliente / No |  |  |

## 22.8 Registro de cambios, releases y despliegues asumidos

| ID | Aplicación | Tipo | Entorno | Cambio aprobado | Ejecutado por entrante | Validación post | Rollback requerido | Resultado |
|---|---|---|---|---|---|---|---|---|
|  |  | Release / Hotfix / Configuración / Batch | DEV / PRE / PRO | Sí / No | Sí / No | Sí / No | Sí / No | Correcto / Fallido |

## 22.9 Registro de mejora continua post-asunción

| ID | Mejora | Origen | Riesgo que reduce | Beneficio | Prioridad | Responsable | Estado |
|---|---|---|---|---|---|---|---|
|  |  | SLA / Incidencia / Escalado / Gap / Riesgo |  |  | Alta / Media / Baja |  | Propuesta / En curso / Cerrada |

# 23. Checklist operativo de Fase 6
...
## 23.7 Checklist ITIL de asunción progresiva

- [ ] Incident Management operado por el equipo entrante.
- [ ] Severidades y prioridades aplicadas correctamente.
- [ ] SLAs y SLOs monitorizados durante la oleada.
- [ ] Escalados al equipo saliente registrados y analizados.
- [ ] Escalados a proveedores externos probados o documentados.
- [ ] Cambios y despliegues ejecutados bajo Change Enablement.
- [ ] Releases y despliegues con evidencias y rollback documentado.
- [ ] Incidencias recurrentes revisadas como problemas.
- [ ] Problemas abiertos trasladados al modelo BAU.
- [ ] Registro de configuración actualizado con nuevo responsable.
- [ ] Runbooks y KB bajo propiedad del equipo entrante.
- [ ] Riesgos residuales aceptados o mitigados.
- [ ] Mejoras post-transición registradas.
- [ ] Modelo BAU inicial activado.
- [ ] Decisión Go / No-Go a Fase 7 basada en evidencias.

# 24. Riesgos específicos de la Fase 6
...
| Incidencias recurrentes no tratadas como problemas | Se estabiliza una operación reactiva y frágil | Abrir problem records y definir acciones preventivas. |
| Cambios ejecutados sin control ITIL | Fallos productivos o falta de trazabilidad | Aplicar Change Enablement y registrar evidencias. |
| Proveedores externos no traspasados operativamente | Escalados lentos o incorrectos | Validar contactos, canales, SLAs y procedimientos de proveedor. |
| Registro de configuración no actualizado | La operación BAU parte de información incorrecta | Actualizar mini-CMDB con responsables, estado y dependencias. |
| Mejoras detectadas no registradas | Se pierden oportunidades de estabilización | Crear registro de mejora continua desde esta fase. |

---

# 25. Criterios de salida de la Fase 6
...
| Incidencias recurrentes revisadas como problemas | Registro de problemas |  |
| Cambios y despliegues trazados | Registro de cambios / releases |  |
| Proveedores operativamente traspasados | Registro de proveedores |  |
| Registro de configuración actualizado | Mini-CMDB / matriz de servicio |  |
| Mejoras post-asunción registradas | Registro de mejora continua |  |
...
# 26. Recomendaciones prácticas para liderar la Fase 6
...
# 27. Resumen ejecutivo de la Fase 6
...
Desde la perspectiva ITIL, esta fase también debe demostrar:

11. Que Incident Management está operado por el equipo entrante.
12. Que Problem Management se activa para incidencias recurrentes.
13. Que Change Enablement controla los cambios durante la asunción.
14. Que Supplier Management se ha transferido de forma operativa.
15. Que el registro de configuración y la base de conocimiento están actualizados.
16. Que la mejora continua queda preparada para la Fase 7.
