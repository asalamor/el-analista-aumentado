...
- *[Plugin de Confluence o extensión del navegador](gaps/06-ux/02-plugin-confluence-pipeline-ai.md)* — integración nativa sin salir de Confluence
...
- *[Conclusión](book/16-conclusion.md)*
